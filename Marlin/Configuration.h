...
#define STRING_CONFIG_H_AUTHOR "(BTT, bugfix config)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 125, 35 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 125, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 48.5, 9.7, -3.1 }
...
#define HOMING_FEEDRATE_MM_M { (80*80), (80*80), (5*85) }  //was 60*80 60*80 5*60
